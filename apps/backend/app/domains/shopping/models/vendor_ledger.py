...
from sqlalchemy import String, ForeignKey, Numeric, DateTime, Text, Index, UniqueConstraint
...
class VendorLedger(Base, IDMixin):
    ...
    # Primary Key is also the vendor_id
...
class LedgerTransaction(Base, IDMixin):
    ...
    platform_fee_amount: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(12, 2),
        nullable=True
