...
class OrderStatus(str, enum.Enum):
    """Order status for COD-only flow."""

    PENDING = "pending"  # Order placed, awaiting processing
    PROCESSING = "processing"  # Order being prepared
    SHIPPED = "shipped"  # Order shipped, payment collected on delivery
...
class Order(Base, IDMixin, AuditMixin):
    ...
    order_number: Mapped[int | None] = mapped_column(
        Integer, unique=True, index=True, nullable=True, server_default="nextval('order_number_seq')"
    )
